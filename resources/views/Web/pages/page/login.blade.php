                    ...
                    <div class="form-group">
                        <div class="col-md-16 margin-bottom-10">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" id="txtLoginName" name="email" class="form-control"
                                    placeholder="Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-16 margin-bottom-20">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="password" name="pass" id="txtLoginPassword" class="form-control"
                    ...
                    */
                    ...
                    <div class="form-group">
                        <div class="col-md-16 text-center">
                            <div class="form-group">
                                <button type="submit" style="min-width: 220px;" id="btnLogin"
                ...
                <form action="<?php echo $DOMAIN; ?>" method="POST">
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            ...
                            <input type="text" style="height: 30px;" name="fullname" id="txtName" class="form-control"
                                placeholder="Họ tên">
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" style="height: 30px;" name="email" id="txtEmail" class="form-control"
                                    placeholder="Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            <label class="control-label font-16"><span style="color: red;">*</span>&nbsp;Mật
                                khẩu</label>
                            <div class="input-icon">
                                <i class="fa fa-lock"></i>
                                <input type="password" style="height: 30px;" name="password" id="txtMatKhau"
                                    class="form-control" placeholder="Mật khẩu">
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            <label class="control-label font-16"><span style="color: red;">*</span>&nbsp;
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            <label class="control-label font-16"><span style="color: red;">*
                                </span>&nbsp;Số điện thoại</label>
                            <div class="input-icon">
                                <i class="fa fa-phone-square"></i>
                                <input type="text" style="height: 30px;" name="phone" id="txtDienThoai"
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            ...
                            <div class="input-icon">
                                ...
                                <select id="cboSex" style="height: 30px;" class="form-control"
                                    data-placeholder="Giới tính" tabindex="1">
                        ...
                        <div class="col-md-16">
                            <div class="form-group">
                                ...
                                <span style="display: normal">Tôi cam kết tuân theo <a href="#chinhsachbaomat-pop-up"
                                        ...
                                        href="#dieukhoansudung-pop-up" class="fancybox-fast-view">điều khoản sử dụng</a>
                                    của
                                    BetaCinemas.
                                </span>
                                <span style="display: none">I have read and accecpt the <a
                                        href="#chinhsachbaomat-pop-up" class="fancybox-fast-view">Privacy policy</a> and
                                    <a href="#dieukhoansudung-pop-up" class="fancybox-fast-view">Terms and
                                        conditions</a> of BetaCinemas.
                                </span>
                            </div>
                        </div>
                    </div>

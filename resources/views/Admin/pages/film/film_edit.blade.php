                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Trailer</label>
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][trailer]" type="text"
                                            class="form-control" required placeholder="trailer (link youtobe)"
                                            value="<?php echo $data['trailer']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Thời gian</label>
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][time]" type="text" class="form-control"
                                            required placeholder="Thời gian" value="<?php echo $data['time']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Ngôn ngữ</label>
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][language]" type="text"
                                            class="form-control" required placeholder="Ngôn ngữ"
                                            value="<?php echo $data['language']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Thể loại</label>
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][genres]" type="text"
                                            class="form-control" required placeholder="Thể loại"
                                            value="<?php echo $data['genres']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Nhân vật chính</label>
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][characters]" type="text"
                                            class="form-control" required placeholder="Nhân vật chính"
                                            value="<?php echo $data['characters']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Tác giả, đạo diễn</label>
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][director]" type="text"
                                            class="form-control" required placeholder="Tác giả, đạo diễn"
                                            value="<?php echo $data['director']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Ngày phát hành</label>
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][release_date]" type="text"
                                            class="form-control" required placeholder="Ngày phát hành"

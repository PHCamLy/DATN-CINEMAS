                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][price]" min="0"
                                            class="form-control number price" value="0" required
                                            placeholder="Số tiền giảm ...">
                                        <input name="data[<?php echo $alias; ?>][percent]" min="0"
                                            class="form-control percent number d-none" value="0" required
                                            placeholder="% giảm ...">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="data[<?php echo $alias; ?>][time]" min="0"
                                            class="form-control datedtime time" value="" required

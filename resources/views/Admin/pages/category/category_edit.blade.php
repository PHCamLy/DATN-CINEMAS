                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Loại mục lục</label>
                                    <div class="col-lg-10">
                                        <select id="price-option" name="data[<?php echo $alias; ?>][type]"
                                            class="form-select" required>
                                            <?php	 foreach($category_type as $k => $v) { 	 ?>
                                            <option value="<?php echo $k; ?>" <?php echo $data['type']==$k ? 'selected'
                                                :''; ?>>
                                                <?php	 echo $v; 	 ?>
                                            </option>
                                            <?php	 } 	 ?>
                                ...
                                <div class="row mb-4">
                                    <label class="col-form-label col-lg-2">Hiển thị trên menu</label>
                                    <div class="col-lg-10">
                                        <select id="price-option" name="data[<?php echo $alias; ?>][menu]"
                                            class="form-select">
                                            <option value="1" <?php echo $data['menu']==1 ? 'selected' :''; ?>>Hiển thị
                                            </option>
                                            <option value="0" <?php echo $data['menu']==0 ? 'selected' :''; ?>>không
                                                hiển thị</option>
                                        </select>
                                    </div>
                                </div>
